...
public class CommUtil {
	...
	//身份证正则表达式
	private static String isIDCard="^\\d{15}$|^\\d{17}[0-9Xx]$";
	...
	public static void quitApp(final Context context) {
		...
		new AlertDialog.Builder(context).setTitle("退出应用").setMessage("确认是否立即退出应用吗？")
	 ...
	 * 要匹配的字符串
	 */
	public static boolean isRegx(String params){
		boolean isID = match(isIDCard,params);
	 ...
	 * @return
	 */
	public static String getParamsValue(String url,String key){
		//获取reportTypeCode
		try
		{
